 ...
 *
 * Exported because the completion scripts are not the only thing that must name
 * a group's subcommands: `handleUnknownSubcommand` in `index.ts` prints the
 * same list as a usage line. Both read it from the tree.
 */
