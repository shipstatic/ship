...
let setConfigUnderTest: typeof import('@/core/platform-config').setConfig;
let getCurrentConfigUnderTest: typeof import('@/core/platform-config').getCurrentConfig;
let isConfigInitializedUnderTest: typeof import('@/core/platform-config').isConfigInitialized;
let resetConfigUnderTest: typeof import('@/core/platform-config').resetConfig;
...
describe('Platform Config Module Tests', () => {
  beforeEach(async () => {
    ...
    const platformConfigModule = await import('@/core/platform-config.js');
