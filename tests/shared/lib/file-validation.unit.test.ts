...
// ---------------------------------------------------------------------------
// Merged from file-validation.boundaries.unit.test.ts (2026-07-27). Roughly a
// third of it duplicated the assertions above; the genuine ±1-byte boundary
// content is kept, now beside the rules it bounds.
// ---------------------------------------------------------------------------
